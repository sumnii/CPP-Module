...
int main() {
	...
	std::cout << "~ int 배열 : {1,2,3,4,5} ~" << std::endl;
	std::cout << "출력 함수 실행" << std::endl;
	iter(i_arr, sizeof(i_arr) / sizeof(int), print_t);
	std::cout << std::endl;

	std::cout << "add_num 함수 실행 (+3)" << std::endl;
	...
	char c_arr[3] = {'a', 'b', 'c'};
	std::cout << "~ char 배열 : {'a','b','c'} ~" << std::endl;
	std::cout << "출력 함수 실행" << std::endl;
	...
	std::cout << "~ string 배열 {\"hello\",\"world\"} ~" << std::endl;
	std::cout << "출력 함수 실행" << std::endl;
